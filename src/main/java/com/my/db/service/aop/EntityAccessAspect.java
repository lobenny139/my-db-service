...
public class EntityAccessAspect {
     ...
     */
    @Pointcut("execution(* com.my.db.service.provider..*(..)) || execution(* com.my.db.access.tool..*(..))")
...
//            if (("updateEntity").equals(methodName) ) {
            ...
            if(object != null && object.getClass().getCanonicalName().indexOf("java.util.ArrayList") >=0){
                ...
                logger.info("[{}] - [{}] 結束" + op + "資料, 成功." , clazzName, methodName);
            }
